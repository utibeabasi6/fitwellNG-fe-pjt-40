window.onload = (e) =>{
    ...
    button1.onclick =  e => {
        ...
        document.getElementById('img').style.backgroundImage = 'url(/assets/images/sign-up-bg2.png)';
    ...
    button2.onclick =  e => {
        ...
        document.getElementById('img').style.backgroundImage = 'url(/assets/images/sign-up-bg3.png)';
